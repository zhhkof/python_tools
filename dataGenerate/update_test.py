...
end_time_str = "2016-12-31 00:00:00"
...
while st < et:
    ...
    sql = '''update public.onedata set wtstatus = '2',faultcode='1',stopcode='1'  where wtstatus = '2' and wtid in (140802200, 140802201, 140802202, 140802203) and ((onedata.endelec - onedata.beginelec) - onedata.theorypower / 60) < 0 and (rectime between ''' + st.strftime(
